 ...
 *
 *=========================================================================*/
#ifndef elxAdvancedMeanSquaresPartialMetric_hxx
#define elxAdvancedMeanSquaresPartialMetric_hxx

#include "elxAdvancedMeanSquaresPartialMetric.h"
...
void
AdvancedMeanSquaresPartialMetric<TElastix>::Initialize(void)
{
  itk::TimeProbe timer;
  timer.Start();
...
template <class TElastix>
void
AdvancedMeanSquaresPartialMetric<TElastix>::BeforeEachResolution(void)
{
...
#endif // end #ifndef elxAdvancedMeanSquaresPartialMetric_hxx
