 ...
 *
 *=========================================================================*/
#ifndef elxTransformBendingEnergyPenaltyTermAnalytic_h
#define elxTransformBendingEnergyPenaltyTermAnalytic_h
...
/**
 * \class TransformBendingEnergyPenaltyAnalytic
 ...
 *    <tt>(Metric "TransformBendingEnergyPenaltyAnalytic")</tt>
 *
 * \ingroup Metrics
 *
 */
...
public:
  /** Standard ITK-stuff. */
  using Self = TransformBendingEnergyPenaltyAnalytic;
  using Superclass1 = itk::TransformBendingEnergyPenaltyTermAnalytic<typename MetricBase<TElastix>::FixedImageType, double>;
  ...
  itkTypeMacro(TransformBendingEnergyPenaltyAnalytic, itk::TransformBendingEnergyPenaltyTermAnalytic);

  /** Name of this class.
   * Use this name in the parameter file to select this specific metric. \n
   * example: <tt>(Metric "TransformBendingEnergyPenaltyAnalytic")</tt>\n
   */
  elxClassNameMacro("TransformBendingEnergyPenaltyAnalytic");
...
protected:
  /** The constructor. */
  TransformBendingEnergyPenaltyAnalytic() = default;

  /** The destructor. */
  ~TransformBendingEnergyPenaltyAnalytic() override = default;

private:
  elxOverrideGetSelfMacro;

  /** The deleted copy constructor. */
  TransformBendingEnergyPenaltyAnalytic(const Self &) = delete;
...
#  include "elxTransformBendingEnergyPenaltyTermAnalytic.hxx"
#endif
