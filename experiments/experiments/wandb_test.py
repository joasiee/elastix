...
params = Parameters.from_base(downsampling_f=1, sampler="Full").optimizer("AdaptiveStochasticGradientDescent").stopping_criteria(iterations=1000).instance(Collection.EXAMPLES, 1)
